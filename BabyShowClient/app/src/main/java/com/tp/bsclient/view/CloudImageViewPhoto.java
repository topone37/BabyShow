...
public class CloudImageViewPhoto extends View {
    ...
    public CloudImageViewPhoto(Context paramContext) {
        super(paramContext);
        mContext = paramContext;
        init();
    }

    public CloudImageViewPhoto(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        mContext = paramContext;
        init();
    }

    public CloudImageViewPhoto(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    public void init() {
        drawable = (BitmapDrawable) mContext.getResources().getDrawable(R.drawable.photo_bg);
...
//            this.getLayoutParams().height = drawable.getBitmap().getHeight() * right / drawable.getBitmap().getWidth();
            this.getLayoutParams().height = mContext.getResources().getDisplayMetrics().heightPixels;
        }
    }
    ...
    public class CloudHandler extends Handler {
        ...
        public void handleMessage(Message paramMessage) {
            ...
            CloudImageViewPhoto.this.invalidate();
